...
from apps.v1.accounts.models import UserConfirmation
from apps.v1.shared.enums import AuthTypes
from apps.v1.shared.utility import send_email, send_phone_code
