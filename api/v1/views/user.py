...
# from api.v1.serializers.user_serializers import RegisterSerializer
...
#         entity = service.register(dto=type("obj", (), {"email": serializer.validated_data["email"]}))
#         return Response({"id": entity.id, "email": entity.email}, status=status.HTTP_201_CREATED)
